  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#030303] relative overflow-hidden p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-card p-10 border-white/5 bg-[#050505] relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)]" data-testid="register-page">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-xs font-mono tracking-widest text-cyan-500/80 uppercase">Hesabınızı Oluşturun</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6" data-testid="register-form">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs text-gray-500 font-mono tracking-widest uppercase">Ad Soyad</Label>
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-cyan-500/50" size={18} />
                <Input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div className="text-xs font-mono tracking-widest uppercase text-center mt-4">
              <span className="text-gray-500">ZATEN HESABINIZ VAR MI? </span>
              <Link to="/login" className="text-cyan-500 hover:text-cyan-400 hover:underline transition-colors block mt-2" data-testid="login-link">
                BURADAN GİRİŞ YAPIN
              </Link>
            </div>
