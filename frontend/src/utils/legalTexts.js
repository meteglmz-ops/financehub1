export const LEGAL_DOCS = {
    ...
    privacy: {
        ...
        content: `
            ...
            <p>Hizmet kalitesini artırmak amacıyla kullanıcı adı, e-posta adresi ve kullanım verileri toplanabilir.</p>
            
            <h3>2. Veri Kullanımı</h3>
            <p>Toplanan veriler, hesap yönetimi, güvenlik ve hizmet iyileştirme amaçlarıyla kullanılır. Üçüncü taraflarla pazarlama amacıyla paylaşılmaz.</p>
            
            <h3>3. Çerezler</h3>
            <p>Kullanıcı deneyimini iyileştirmek için çerezler (cookies) kullanılmaktadır. Tarayıcı ayarlarından çerezleri yönetebilirsiniz.</p>
            
            <h3>4. Veri Güvenliği</h3>
            <p>Kişisel verileriniz endüstri standardı güvenlik önlemleriyle korunmaktadır.</p>
        `
    },
    legal: {
        title: "Yasal Uyarı",
        content: `
            ...
            <p>Bu platformdaki tüm veriler, piyasa koşullarına göre gecikmeli olabilir ve kesinlik taşımaz.</p>
            
            <h3>2. Yatırım Riski</h3>
            <p>Finansal piyasalarda işlem yapmak yüksek risk içerir. Kullanıcılar kendi kararlarından %100 sorumludur.</p>
            
            <h3>3. Yargı Yeri</h3>
            <p>Olası uyuşmazlıklarda yerel mahkemeler yetkilidir.</p>
        `
    },
    disclaimer: {
